...
namespace St
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jquery", "http://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.3.1.min.js").Include("~/Scripts/lib/jquery/dist/jquery-3.3.1.slim.min.js"));
